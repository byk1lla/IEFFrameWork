...
<div class="auth-stage">
    <div class="auth-card">
        <div class="auth-header">
            <h1>Identity <span>Logic</span></h1>
            <p>ACCESSING THE TITAN MATRIX</p>
        </div>
        ...
        <form action="/login" method="POST">
            ...
            <button type="submit" class="btn-auth">Initialize Access</button>
        </form>

        <div class="auth-footer">
            No identity? <a href="/register">Establish Uplink</a>
        </div>
    </div>
</div>
@endsection