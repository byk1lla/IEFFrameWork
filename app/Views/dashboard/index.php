...
<div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
            <h1 class="text-2xl lg:text-3xl font-bold">Merhaba,
                <?= htmlspecialchars($authUser['name'] ?? 'Kullanıcı') ?>! 👋</h1>
            <p class="text-gray-400 mt-1">İşte güncel finansal özetin</p>
        </div>
        <a href="/fatura/yeni"
            class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-primary-500 to-primary-600 rounded-xl font-semibold hover:shadow-lg hover:shadow-primary-500/30 transition">
    ...
    <div id="stats-container">
        <!-- Loading skeleton with spinner in all cards -->
